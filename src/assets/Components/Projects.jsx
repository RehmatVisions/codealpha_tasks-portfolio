...
const Projects = () => {
 ...
 <h1   id="pro">My<span id="spanone">.</span>Projects</h1>
  <div className="maincard" id="maincards">
      <ProCards title="Spotify Clone-Music Streaming Platform" desc= "A Spotify-style music streaming clone built with HTML, CSS,  featuring a layout, player controls, and interactive UI." btn="View" link="t-projects/spotify%20clone/index.html"/>
  ...
  {/* <ProCards title="Amazon Clone - HTML&CSS Only" desc="A simple Amazon website clone built using only HTML and CSS.header,banner, product sections, and footer" btn="view"  link="/t-projects/amazon%20clone/index.html" /> */}
   <ProCards title="Eduisty React" desc="Created a fully functional and responsive frontend clone of the Eduisty website using React, showcasing modern UI design principles." btn="view"  link="https://comfy-cendol-b1f477.netlify.app/" />
    <ProCards title="Gotto Website" desc="A fully responsive bussiness Platform Built in React. Styled with passion. Delivered as Gotto." btn="View" link="https://profound-bavarois-7ff36a.netlify.app/" />
 ...
 <ProCards title="Streamlabs Website Clone" desc="A fully responsive Streamlabs-inspired ReactJS project with modern UI, smooth animations, and dynamic component structure." btn="View" link="https://sprightly-kashata-a0ade8.netlify.app/" />
